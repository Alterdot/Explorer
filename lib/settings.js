...
exports.api_page = {
  ...
  "public_apis": {
    ...
    "rpc": {
      ...
      "resolvedomain": {
      // enabled: Enable/disable the /api/resolvedomain api endpoint (true/false)
      //          If set to false, the /api/resolvedomain api will be completely disabled for public use (no definition on the api page and a disabled error msg if you try to call the endpoint directly)
        "enabled": true
      }
    },
...
exports.api_cmds = {
  ...
  // resolvedomain: Resolves a BDNS domain name to an IPFS/IPNS hash stored in the blockchain.
  "resolvedomain": "resolvedomain" // TODO_BCRS_LOW move to blockchain_specific TODO_BCRS_FUTURE create domain name database
};
